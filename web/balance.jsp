...
//PreparedStatement ps=con.prepareStatement("Select * from MAILCASTINGUSER where EMAILADD = ? and PASSWORD =?");
	...
	ResultSet rs2=st2.executeQuery();
			...
			out.print("<tr><br><th>ACCOUNT NO</th><th>USERNAME</th><th>AMOUNT</th></tr>");
			while(rs2.next())
                        
                        {
			    	
			%>
                        <tr><td><%=rs.getString("account")%></td><td><%=rs.getString("username")%></td><td><%=rs.getString("amount")%></td></tr>
          ...
          <%                      
			...
			out.print("Please check your username and Password");
             ...
             response.sendRedirect("balance1.jsp");
